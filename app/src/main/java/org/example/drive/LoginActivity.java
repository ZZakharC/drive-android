...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Клик по Нет аккаунта
        TextView switchToLogin = findViewById(R.id.register_btn);
    ...
    // Логин пользователя (получает данные с input)
    protected void login() {
        ...
        if (loginText.length() < Config.MIN_LOGIN_LENGTH)
            ...
            try {
                ...
                Server.post("auth/login", body, new Server.Callback() {
                    @Override
                    public void onResponse(int statusCode, String responseBody, Map<String, String> headers) {
                        if (statusCode == 200) {
                            ...
                            errorText.setText(getString(R.string.error_login_or_password_incorrect));
